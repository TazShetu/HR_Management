            ...
            <div class="col-lg-10 offset-lg-1 mb-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">Pay Scale Update</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{route('payScale.update', ['pid' => $p->id])}}" class="form-horizontal"
                              method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" step="0.01" min="0" name="pay" value="{{$p->pay}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea
                                            ...
                                            name="BenefitDetails" id="" cols="30" rows="3"
                                            required>{{$p->benefit_detail}}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea
                                            ...
                                            name="familySupportDetails" id="" cols="30" rows="3"
                                            required>{{$p->family_support_detail}}</textarea>
