                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" name="maxLeavePerType" min="0" value="{{$maxLeavePerType}}"
                                           id="mlpt"
                                           class="form-control form-control-success {{$errors->has('maxLeavePerType') ? 'has-error' : ''}}"
                                           required>
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('leaveType.update', ['ltid' => $ltEdit->id])}}" class="form-horizontal"
                              method="post">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @endif
                                    <input type="text" placeholder="Leave Type" name="type" value="{{$ltEdit->type}}"
                                           class="form-control form-control-success {{$errors->has('type') ? 'has-error' : ''}}"
                                           required>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @if (($lt->id * 1) != 1)
                                            ...
                                            @else
                                                <a href="#" class="btn btn-sm disabled btn-success">Edit</a>
